...
# ==========================================
    ...
    if not db_clients:
        ...
        with st.form("new_report_form"):
            ...
            # Formato data Giorno-Mese-Anno gestito tramite stringa formattata
            raw_report_date = st.date_input("Data Esecuzione", datetime.today())
            report_date = raw_report_date.strftime("%d/%m/%Y")
            
            # Inserimento orario / durata del servizio
            report_duration = st.text_input("Durata del Servizio (es. 2 ore e 30 min, oppure 08:00 - 11:30)")
            ...
            if submit_report:
                ...
                # Se è stata caricata una foto, la salviamo temporaneamente o la gestiamo nella spesa
                photo_filename = None
