...
# --- FUNZIONE SUPPORTO PER APRIRE PDF VIA HTML (BASE64) ---
def display_pdf_link(pdf_path, label="🌐 Apri PDF"):
    if os.path.exists(pdf_path):
        with open(pdf_path, "rb") as f:
            base64_pdf = base64.b64encode(f.read()).decode('utf-8')
        pdf_display = f'<iframe src="data:application/pdf;base64,{base64_pdf}" width="100%" height="600" type="application/pdf" style="display:none;"></iframe>'
        # Link HTML per aprire in una nuova scheda
        html_link = f'''
...
# ==========================================
    ...
    if not db_clients:
        ...
        if st.session_state.last_generated_pdf and os.path.exists(st.session_state.last_generated_pdf):
            ...
            with col_open_new:
                display_pdf_link(st.session_state.last_generated_pdf)
